<template>
  <div class="pay">
    <van-nav-bar title="订 单 结 算 台" left-text="返回" left-arrow @click-left="$router.go(-1)" fixed placeholder/>
    ...
    <div class="address">
      ...
      <div class="info" v-if="true">
        <div class="info-content">
          <span class="name">小樱花</span>
          <span class="mobile">13711113333</span>
        </div>
